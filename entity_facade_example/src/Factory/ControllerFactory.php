...
use Drupal\node\NodeInterface;
use Drupal\entity_facade\Factory\EntityControllerBaseFactory;
...
class ControllerFactory extends EntityControllerBaseFactory {
   ...
   *
   * @return \Drupal\entity_facade_example\Plugin\EntityController\Node\ArticleCtrl
   ...
   * @param \Drupal\node\NodeInterface $node
   *
   * @return \Drupal\entity_facade_example\Plugin\EntityController\NodeBasicPage
   * @throws \Drupal\Component\Plugin\Exception\PluginException
   */
   ...
   *
   * @return \Drupal\entity_facade_example\Plugin\EntityController\UserCtrl
   * @throws \Drupal\Component\Plugin\Exception\PluginException
   */
